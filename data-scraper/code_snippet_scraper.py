...
def scrape_code_snippet(url="",project_id=''):
...
#scrape_code_snippet(url="https://create.arduino.cc/projecthub/saulius-bandzevicius/arduino-based-universal-ac-motor-speed-controller-a4ceaf?ref=platform&ref_id=424_trending___&offset=13")
