 ...
 * @generated
 */
public class ArdModelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ArdModelPackage.SCENARIO: {
				Scenario scenario = (Scenario)theEObject;
				T result = caseScenario(scenario);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArdModelPackage.APPLICATION: {
				Application application = (Application)theEObject;
				T result = caseApplication(application);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArdModelPackage.DESCRIPTED: {
				Descripted descripted = (Descripted)theEObject;
				T result = caseDescripted(descripted);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArdModelPackage.BOARD: {
				Board board = (Board)theEObject;
				T result = caseBoard(board);
				if (result == null) result = caseDescripted(board);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArdModelPackage.PIN: {
				Pin pin = (Pin)theEObject;
				T result = casePin(pin);
				if (result == null) result = caseDescripted(pin);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArdModelPackage.CONNECTION: {
				Connection connection = (Connection)theEObject;
				T result = caseConnection(connection);
				if (result == null) result = caseDescripted(connection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArdModelPackage.WIFI: {
				Wifi wifi = (Wifi)theEObject;
				T result = caseWifi(wifi);
				if (result == null) result = caseDescripted(wifi);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArdModelPackage.ETHERNET: {
				Ethernet ethernet = (Ethernet)theEObject;
				T result = caseEthernet(ethernet);
				if (result == null) result = caseDescripted(ethernet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
